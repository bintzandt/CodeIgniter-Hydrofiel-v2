...
<?= form_open(); ?>
    <div class="form-group">
        ...
        <input style="cursor: not-allowed" id="name" name="name" type="text" class="form-control" disabled
               value="<?= $user->name ?>">
    </div>
    <div class="form-group">
        ...
        <input id="password2" name="password2" type="password" class="form-control"
               placeholder="<?= lang('Auth.confirmPassword') ?>" autocomplete="new-password">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <label class="form-check-label"><input class="form-check-input" type="checkbox" name="showEmail"
                                                   value="1" <?= $user->showEmail ? 'checked' : '' ?>><?= lang(
                    "User.showEmail"
                ) ?></label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="form-check">
            <label class="form-check-label"><input class="form-check-input" type="checkbox" name="receiveNewsletter"
                                                   value="1" <?= $user->receiveNewsletter ? 'checked' : '' ?>> <?= lang(
                    "User.newsletterHelp"
                ) ?></label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="form-check">
            <label class="form-check-label"><input class="form-check-input" type="checkbox" name="preferEnglish"
                                                   value="1" <?= $user->preferEnglish ? 'checked' : '' ?>> I want to
                receive
