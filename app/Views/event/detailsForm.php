...
<div class="form-group">
    ...
    <div class="col">
        <input type="radio" id="preborrel" name="preborrel" value="1"
               required <?= $edit_mode && $details->preborrel ? 'checked' : '' ?>> <?= lang('Event.yes'); ?>
        <input type="radio" name="preborrel" value="0"
               required <?= $edit_mode && !$details->preborrel ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        <input type="radio" id="avondeten" name="avondeten" value="1"
               required <?= $edit_mode && $details->avondeten ? 'checked' : '' ?>> <?= lang('Event.yes'); ?>
        <input type="radio" name="avondeten" value="0"
               required <?= $edit_mode && !$details->avondeten ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        <input type="radio" id="feest" name="feest" value="1"
               required <?= $edit_mode && $details->feest ? 'checked' : '' ?>> <?= lang('Event.yes'); ?>
        <input type="radio" name="feest" value="0"
               required <?= $edit_mode && !$details->feest ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        <input type="radio" id="slapen" name="slapen" value="0"
               required <?= $edit_mode && $details->slapen == 0 ? 'checked' : '' ?>> <?= lang('Event.not'); ?>
        <input type="radio" id="slapen" name="slapen" value="1"
               required <?= $edit_mode && $details->slapen == 1 ? 'checked' : '' ?>> <?= lang('Event.friday') ?>
        <input type="radio" name="slapen" value="2"
               required <?= $edit_mode && $details->slapen == 2 ? 'checked' : '' ?>> <?= lang('Event.saturday') ?>
        <input type="radio" name="slapen" value="3"
               required <?= $edit_mode && $details->slapen == 3 ? 'checked' : '' ?>> <?= lang('Event.both') ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        ...
        <input type="radio" name="groep_heen" value="2"
               required <?= $edit_mode && $details->groep_heen == 2 ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        ...
        <input type="radio" name="groep_terug" value="2"
               required <?= $edit_mode && $details->groep_terug == 2 ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<div class="form-group">
    <div class="col">
    ...
    <div class="col">
        <input type="radio" id="speciaal" name="speciaal" value="1"
               required <?= $edit_mode && $details->speciaal ? 'checked' : '' ?>> <?= lang('Event.yes'); ?>
        <input type="radio" name="speciaal" value="0"
               required <?= $edit_mode && !$details->speciaal ? 'checked' : '' ?>> <?= lang('Event.no'); ?>
    </div>
</div>
<button class="btn btn-primary center-block"><?= lang('Event.save'); ?></button>
<?= form_close(); ?>
<?= $this->endSection(); ?>