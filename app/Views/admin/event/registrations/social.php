...
<?= $this->section('body') ?>
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <?php
        foreach ($swimmer as $registration) { ?>
            <tr>
                <td class="clickable-row"
                    data-href="/admin/events/registrationDetails/<?= $registration->eventId ?>/<?= $registration->userId ?>"><?= $registration->name ?></td>
                <td class="clickable-row"
                    data-href="/admin/events/registrationDetails/<?= $registration->eventId ?>/<?= $registration->userId ?>"><?= $registration->registrationDate->format(
                        'd-m-Y H:i'
                    ) ?></td>
                <td>
                    <button aria-label="Delete registration" class="delete button--icon"
                            data-memberName="<?= $registration->name ?>" data-eventId="<?= $registration->eventId ?>"
                            data-userId="<?= $registration->userId ?>"><span class="fa fa-trash"
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <?php
        foreach ($waterpolo as $registration) { ?>
            <tr>
                <td class="clickable-row"
                    data-href="/admin/events/registrationDetails/<?= $registration->eventId ?>/<?= $registration->userId ?>"><?= $registration->name ?></td>
                <td class="clickable-row"
