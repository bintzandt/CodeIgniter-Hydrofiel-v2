...
<?= $this->section('body') ?>
    <div class="navigation-link">
        ...
        <a href="/admin/users/addFriend"><b>Vriend van Hydrofiel toevoegen&nbsp;<i aria-hidden="true"
                                                                                   class="fa fa-user-plus"></i></b></a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="table table-sm table-striped table-hover">
                    ...
                    <tbody>
                    <?php
                    foreach ($waterpoloers as $member) {
                        echo view('admin/user/partials/userRow', ['member' => $member]);
                    } ?>
                    </tbody>
                </table>
