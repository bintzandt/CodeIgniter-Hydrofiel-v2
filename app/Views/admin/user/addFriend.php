...
<div class="form-group">
	...
	<div class="form-check">
		<label class="form-check-label"><input type="checkbox" class="form-check-input" id="preferEnglish" name="preferEnglish" value="Ja" <?= set_checkbox('preferEnglish', 'Ja') ?> />Gebruiker is Engelstalig</label>
	</div>
</div>
<div class="form-group">
